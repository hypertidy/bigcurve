...
If we take that same path (A to B, shortest distance) in a different projection we get the *same path* but
at different locations, because the curvature is a different situation here. 
